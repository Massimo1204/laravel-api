...
var render = function () {
  ...
  return _c(
    ...
    {
      staticClass:
        "w-50 d-flex align-items-center flex-column pt-5 pb-2 border-bottom border-secondary",
    },
    [
      _c("h2", { staticClass: "mb-3" }, [_vm._v(_vm._s(_vm.post.user.name))]),
      _vm._v(" "),
      _c("img", {
        staticClass: "mb-4",
        attrs: { src: _vm.post.image_source, alt: "post image" },
      }),
      _vm._v(" "),
      _c("div", { staticClass: "my-content-wrapper clearfix" }, [
...
var render = function () {
  ...
  return _c("div", [
    _c(
      "div",
      {
        staticClass: "my-post-container d-flex align-items-center flex-column",
      },
      [
        _vm._l(_vm.posts, function (post, index) {
          return _c("Post", { key: index + "post", attrs: { post: post } })
        }),
        _vm._v(" "),
        _c("nav", [
...
__webpack_require__(/*! C:\boolean-projects\laravel-api\resources\js\front.js */"./resources/js/front.js");
module.exports = __webpack_require__(/*! C:\boolean-projects\laravel-api\resources\sass\app.scss */"./resources/sass/app.scss");
